...
const Navbar = () => {
  ...
  return (
    <>
        <div className={`mx-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed top-0 right-0 left-0 z-50 ${
            sticky?"sticky-navbar shadow-md bg-base-200 dark:bg-slate-700 dark:text-white duration-400 transition-all ease-in-out":""
        }`}>
